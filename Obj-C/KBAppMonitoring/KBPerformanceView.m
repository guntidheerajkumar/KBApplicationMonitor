...
#import "KBMarginLabel.h"

@interface KBPerformanceView ()

@property (nonatomic, strong) CADisplayLink *displayLink;

@property (nonatomic, strong) KBMarginLabel *monitoringTextLabel;
...
@implementation KBPerformanceView
...
- (void)setupTextLayers {
    self.monitoringTextLabel = [[KBMarginLabel alloc] init];
